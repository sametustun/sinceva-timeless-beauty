import { BlogContentMap } from './index';

export const trBlogContentPart4: BlogContentMap = {
  'toner-benefits': {
    title: 'Toniğin Faydaları: Cilt Bakım Rutininizin Vazgeçilmez Adımı',
    excerpt: 'Tonik kullanmanın cilt bakımındaki önemi ve cildiniz için sağladığı sayısız fayda.',
    content: `
...
Cildinizin ihtiyaçlarına uygun bir tonik seçin, düzenli kullanın ve farkı kendiniz görün. Tonik, basit gibi görünen ancak cildinizde büyük fark yaratan güçlü bir bakım adımıdır!`
  },
  'winter-skincare-tips': {
    title: 'Kış Aylarında Cilt Bakımı: Soğuk Havadan Cildinizi Koruma Rehberi',
    excerpt: 'Kış aylarında cildinizi nasıl korursunuz? Soğuk, rüzgar ve kuru havaya karşı etkili stratejiler.',
    content: `
...
Kış ayları zorlu olsa da, doğru bakım ile cildiniz sağlıklı, nemli ve ışıldayan kalabilir. Cildinizi dinleyin ve ihtiyaçlarına göre rutininizi ayarlayın. Soğuk hava geçici, sağlıklı cilt kalıcıdır!`
  },
  'rose-water-benefits': {
    title: 'Gül Suyunun Faydaları: Doğanın Mucizevi Cilt Bakım Sırrı',
    excerpt: 'Gül suyunun cildinize sağladığı sayısız faydayı ve kullanım yöntemlerini keşfedin.',
    content: `
## Gül Suyu Nedir?
...
Gül suyunu cilt bakım rutininize ekleyin ve bu antik güzellik sırrının modern faydalarını deneyimleyin. Cildiniz size teşekkür edecek!`
  },

...
const Contact: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (existing) {
      ...
      s.async = true;
      s.defer = true;
      s.onload = () => { console.log('turnstile script loaded'); setTimeout(init, 100); };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Token'ı al
    const token = (window as any).__turnstileToken || window.turnstile?.getResponse?.(widgetIdRef.current!);
    
    if (!token) {
      toast({ 
        title: 'Doğrulama gerekli', 
        description: 'Lütfen güvenlik doğrulamasını tamamlayın.', 
        variant: 'destructive' 
      });
      return;
    }
  ...
  const submitWithToken = async (token: string) => {
    try {
      ...
      const res = await fetch('https://sinceva.com/backend/contact.php', {
        method: 'POST',
          ...
          <div className="space-y-8">
            ...
            <div className="mt-8">
              ...
              <div className="aspect-video rounded-lg overflow-hidden shadow-lg bg-muted">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3041.1234!2d29.326644!3d40.664879!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDDCsDM5JzUzLjYiTiAyOcKwMTknMzUuOSJF!5e0!3m2!1str!2str!4v1234567890"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="Sinceva Ofis Konumu - Çiftlikköy, Yalova"
                />
              </div>
            </div>
          </div>
